            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <g:if test="${userInstance instanceof gov.spawar.icode.User}">
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.countryOfInterest.label" default="Country Of Interest" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${userInstance.countryOfInterest}" var="c">
                        ...
                        <g:if test="${userInstance instanceof gov.spawar.icode.User}">
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.destinationOfInterest.label" default="Destination Of Interest" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${userInstance.destinationOfInterest}" var="d">
                                    <li><g:link controller="country" action="show" id="${d.id}">${d?.encodeAsHTML()}</g:link></li>
                                </g:each>
                                </ul>
                            </td>
