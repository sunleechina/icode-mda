                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="aisGeom"><g:message code="location.aisGeom.label" default="Ais Geom" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: locationInstance, field: 'aisGeom', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="ais"><g:message code="location.ais.label" default="Ais" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: locationInstance, field: 'ais', 'errors')}">
                                    <g:select name="ais.id" from="${gov.spawar.icode.Ais.list()}" optionKey="id" value="${locationInstance?.ais?.id}"  />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="date"><g:message code="location.date.label" default="Date" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: locationInstance, field: 'date', 'errors')}">
