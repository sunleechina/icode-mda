			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="geometryObject" title="${message(code: 'location.geometryObject.label', default: 'Geometry Object')}" />
						...
						<g:sortableColumn property="altitude" title="${message(code: 'location.altitude.label', default: 'Altitude')}" />
				...
				<g:each in="${locationInstanceList}" status="i" var="locationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${locationInstance.id}">${fieldValue(bean: locationInstance, field: "geometryObject")}</g:link></td>
						...
						<td>${fieldValue(bean: locationInstance, field: "altitude")}</td>
