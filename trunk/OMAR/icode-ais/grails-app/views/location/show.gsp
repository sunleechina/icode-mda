            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="location.aisGeom.label" default="Ais Geom" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: locationInstance, field: "aisGeom")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="location.ais.label" default="Ais" /></td>
                            
                            <td valign="top" class="value"><g:link controller="ais" action="show" id="${locationInstance?.ais?.id}">${locationInstance?.ais?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="location.date.label" default="Date" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${locationInstance?.date}" /></td>
