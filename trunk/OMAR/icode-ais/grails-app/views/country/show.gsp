            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="country.countryCode.label" default="Country Code" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: countryInstance, field: "countryCode")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="country.callSignPrefixes.label" default="Call Sign Prefixes" /></td>
